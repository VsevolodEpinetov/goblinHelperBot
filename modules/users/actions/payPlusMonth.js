...
module.exports = Composer.action('payPlusMonth', async (ctx) => {
  ...
  try {
    ...
    // Create invoice for plus subscription
    const invoiceResult = await createSubscriptionInvoice(ctx, 'plus', userData.id);
    ...
    console.error('Error in payPlusMonth:', error);
